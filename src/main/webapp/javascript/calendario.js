...
//formulario: datos iniciales:
    document.getElementById("buscaanno").value=annohoy;
...
function primeralinea() {
    for(i=0;i<7;i++){
		...
		celda0.style.backgroundColor="#FBDD04"
    }
}
...
function escribirdias() {
    ...
    for (i=1;i<7;i++) { //localizar fila
        ...
        for (j=0;j<7;j++) {
            ...
            celda.style.backgroundColor="#FFF08F";
            celda.style.color="#000000";
            //domingos en rojo
            if (j==6) {
                celda.style.color="C12200";
            }
            //dias restantes del mes en gris
            if (mimes!=mescal) {
                celda.style.color="#EAA81A";
            }
            //destacar la fecha actual
            if (mimes==meshoy && midia==diahoy && mianno==annohoy ) {
                celda.style.backgroundColor="#C05805";
...
//Recoger dato del año en el formulario
    mianno=document.getElementById("buscaanno").value;
    //recoger dato del mes en el formulario
    listameses=document.getElementById("buscames");
